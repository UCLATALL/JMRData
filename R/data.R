...
#'
#' TODO: what are the units of the rates?
#'
...
#' \describe{
#'   \item{Program}{The program: clinical, developmental, or social}
...
#' @format A data frame with 50 observations of 3 variables:
#' \describe{
#'   \item{Drug}{The drug given: A, B, or Placebo}
#'   \item{Psychotherapy}{Type of psychotherapy administered: treatment or control}
...
#'   \item{teacher}{-1 = A, 1 = B}
#'   \item{pretest}{The student's score on a pretest}
#' }
"ex10.1"
...
#' \describe{
#'   \item{Condition}{Whether the participant was in the treatment or control group}
#'   \item{Criticism}{Number of criticisms}
...
#' \describe{
#'   \item{group}{Group ID}
#'   \item{instructions}{Whether the participants were instructed they were in \code{competition} or not (\code{none})}
#'   \item{score1}{Score on first trial}
#'   \item{score2}{Score on second trial}
#'   \item{score3}{Score on third trial}
#' }
"ex11.1"
...
#'
#' TODO: What are the couple, Male and Female scores?
#'
#' @format A data frame with 16 observations of 5 variables:
#' \describe{
#'   \item{couple}{}
#'   \item{children}{Does the couple have children? ys or no}
...
#'
#' TODO: these don't appear to be reversed. Check textbook for description and method
#'
...
#'   \item{satr}{Reversed values of \code{sat}}
#'   \item{hsrankr}{Reversed values of \code{hsrankr}}
#' }
"ex13.1"
